...
**Created**: 2026-02-14 **Status**: Design Phase **Goal**: Simple
distraction-free text editor for prose writing
...
1. [IBuffer Interface](#ibuffer-interface)
1. [GapBuffer Internals](#gapbuffer-internals)
1. [User Interaction Flows](#user-interaction-flows)
1. [Data Flow Examples](#data-flow-examples)
...
A gap buffer is like a **string with a hole in it**. The hole (gap) sits at the
cursor position, making insertions and deletions very fast.
...
1. Navigate efficiently (word/paragraph jumps)
1. See word count in real-time
